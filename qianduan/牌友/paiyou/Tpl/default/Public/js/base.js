...
$(function(){
    ...
    $('.banner .bd').find('li').width(w);
    jQuery("#banner-slide").slide({mainCell:".bd ul",effect:"leftLoop",autoPlay:true});
    jQuery(".picScroll-left").slide({mainCell:".bd ul",autoPage:true,effect:"left",autoPlay:true,vis:4});
    jQuery(".picScroll-left1").slide({mainCell:".bd ul",autoPage:true,effect:"left",autoPlay:true,vis:3});
