...
$(function(){
    ...
    $(".banner ul li").css({"width":Width,"height":Height});
    $(".index_banner").css({"width":Width-240});
...
//banner
    ...
    $(".open").click(function(){
            ...
            $(".banner").css({"marginLeft":"-120px","width":Width-120});
            $(".index_banner").css({"width":Width-240}).stop().animate({"left":"240px"});
    ...
    $(".close").click(function(){
        ...
        home.parent().find(".menu").removeClass("on").stop().animate({"left":"-240px"});
    });
//    首页导航
