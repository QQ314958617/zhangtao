...
<div class="sub-banner" style="background: url('__ROOT__/Uploads/pictures/<?php echo ($ad_info['ad_img']); ?>') no-repeat center top">
	...
	<div class="position">
    <div class="wrap">
        当前位置： <a href="/">首页 </a> / <span><?php echo ($cname["nav_name"]); ?></span>
    </div>
</div>
...
<div class="wrap clearfix">
    <div class="news-left fl">
        <div class="news-content-detail">
            <div class="news-content">
                ...
                <div class="title-box">
                    ...
                    <div class="time-div clearfix">
                        <span class="time fl"><?php echo date('Y年m月d日H:i',$info['published']);?></span>
                        <span class="author fl">编辑:<?php echo ($auther); ?></span>
                ...
                <div class="link">
                   <!-- 上一篇：<a href="#">男子指责女生与儿子出走有关 将其打成精神分裂</a>-->
            ...
            <script type="text/javascript" src="http://v2.uyan.cc/code/uyan.js?uid=2043259"></script>
            <!-- UY END -->
        </div>
    </div>
    <div class="news-right fl">
        ...
        <ul>
        	<?php if(is_array($hlist)): $i = 0; $__LIST__ = $hlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                <a href="<?php echo U('News/read',array('id'=>$vo['id']));?>"><img src="__ROOT__<?php echo ($vo["titlepic"]); ?>" alt=""/></a>
                <h6><a href="<?php echo U('News/read',array('id'=>$vo['id']));?>">
                    <?php echo ($vo["title"]); ?>
                </a></h6>
